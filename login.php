  ...
  <div style="background: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.10);">
    ...
    <div style="background: #1a2e4a; padding: 32px 24px; text-align: center;">
      <div style="width: 56px; height: 56px; background: rgba(58,142,255,0.2); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 14px;">
        <i class="fa fa-shopping-bag" style="font-size: 26px; color: #3a8eff;"></i>
      </div>
      <p style="color: #ffffff; font-size: 18px; font-weight: bold; margin: 0 0 4px;">Almacén los Almendros</p>
      <p style="color: rgba(255,255,255,0.55); font-size: 13px; margin: 0;">Inicia sesión para continuar</p>
    </div>
    ...
    <div style="padding: 28px 24px;">
      <form action="verify.php" method="POST">
        ...
        <button type="submit" name="login" class="btn btn-block btn-flat"
      ...
      <div style="margin-top: 18px; display: flex; flex-direction: column; align-items: center; gap: 8px;">
        <a href="password_olvidada.php" style="font-size: 13px; color: #3a8eff;">Olvidé mi contraseña</a>
        <a href="registrarse.php" style="font-size: 13px; color: #3a8eff;">Crear cuenta nueva</a>
