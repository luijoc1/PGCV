...
$pdf->Ln(2);
$col1 = ['Cliente' => $sale['nombre_facturacion'], 'Documento' => $sale['documento'], 'Correo' => $sale['email']];
$col2 = ['Dirección' => $sale['direccion'], 'Ciudad' => $sale['ciudad'], 'Teléfono' => $sale['telefono']];
$y_start = $pdf->GetY();
$pdf->SetX(15);
...
// MÉTODO DE PAGO
$metodos = ['tarjeta' => 'Tarjeta de crédito / débito', 'transferencia' => 'Transferencia / PSE', 'efectivo' => 'Efectivo (pago contraentrega)'];
